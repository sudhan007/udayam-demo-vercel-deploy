...
import service3 from "../../assets/home/Service3.jpeg"
...
const Services: React.FC = () => {
  ...
  return (
    <div className="mx-auto max-w-[1280px] overflow-x-hidden rounded-xl px-5 py-14 text-[#1a1a2e] md:px-8 lg:px-10">
      ...
      {/* <div
        ref={headerRef}
        className="px-5 pb-4 pt-7 transition-all duration-700"
        style={{ opacity: headerVisible ? 1 : 0, transform: headerVisible ? "none" : "translateY(28px)" }}
      >
        <div className="mb-2 flex items-center gap-2.5 font-mono text-[10px] font-bold uppercase tracking-[0.28em] text-green-700">
          <span className="h-px w-5 flex-shrink-0 bg-green-700" />
          Our Specialties
        </div>
        <h1 className="font-serif text-[26px] font-bold leading-[1.15] tracking-[-0.02em] text-[#1B2B6B]">
          World-Class Care,<br />
          <em className="not-italic text-green-700">Every Specialty</em>
        </h1>
      </div> */}
