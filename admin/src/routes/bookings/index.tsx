...
import { Eye, Calendar, User, Tag, Sparkles } from 'lucide-react'
              ...
              bookings.map((booking) => (
                <TableRow key={booking._id} className="hover:bg-muted/30">
                  ...
                  <TableCell className="text-right">
                    <Link to="/bookings/$id" params={{ id: booking._id }} search={{ type: booking.bookingType === 'CUSTOMIZED' ? 'customized' : 'standard' }}>
